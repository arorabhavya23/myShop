<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataMiningMasterPage.master" CodeFile="ShippingDetails.aspx.cs"
    ...
    <asp:Content ID="ShowItem" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <asp:Panel ID="Panel1" runat="server">
            <asp:GridView ID="GridView1" runat="server" Style="position: relative; top: 4px; left: 0px;" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Market Price">
                        <ItemTemplate>
                            <asp:Label ID="lblOffer" runat="server" Text='<%#Eval("Ourprice") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <table width="100%">
                ...
                <tr>
                  ...
                  <br />          
        <asp:Panel ID="Panel3" runat="server" style="text-align: justify">
