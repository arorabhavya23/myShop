<%@ Page Title="" Language="C#" MasterPageFile="~/DataMiningMasterPage.master" AutoEventWireup="true" CodeFile="Telivisions.aspx.cs" Inherits="Telivisions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server"   Height="528px" ScrollBars="Auto">
       <asp:DataList ID="DataList1" runat="server" CellSpacing="45" DataKeyField="ProdId" DataSourceID="SqlDataSource2" RepeatColumns="3">
            <ItemTemplate>
...
<asp:ImageButton ID="ImageButton1" runat="server" Height="27px" commandargument='<%# Eval("Prodid") %>' ImageUrl='~/css/images/addtocart.gif' Width="73px" OnClick="ImageButton1_Click" />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ecomdatabaseConnectionString %>" SelectCommand="SELECT * FROM [NewProduct] WHERE ([CatgId] = '7')">
        </asp:SqlDataSource>
