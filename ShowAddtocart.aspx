        ...
        <asp:UpdatePanel ID="up1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:GridView ID="GridView1" runat="server" CellPadding="3" AutoGenerateColumns="False"
                    BackColor="White" OnRowDeleting="GridView1_RowDeleting" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" Width="700px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Offer Price">
                            <ItemTemplate>
                                <asp:Label ID="lblOffer" Text='<%#Eval("OurPrice") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Delete">
                            <ItemTemplate>
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CommandName="Delete" CommandArgument='<%Eval("ProdId") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
