<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminDataminingMasterPage.master" AutoEventWireup="true" CodeFile="AddNewAdmin.aspx.cs" Inherits="Admin_AddNewAdmin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">


    <h2 style="color: #000000; text-align: center; text-decoration: underline">Add New Admin</h2>
    ...
    <table align="center" cellpadding="3" style="border: medium groove #000000; width: 555px; height: 182px">
        ...
        <tr>
            ...
            <td style="border: medium groove #000000; width: 324px; height: 31px;">
                <asp:TextBox ID="TextBoxAddress" runat="server" Height="31px" TextMode="MultiLine" Width="239px"></asp:TextBox>
