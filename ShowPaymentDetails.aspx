<%--<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DataMiningMasterPage.master" CodeFile="ShowPaymentDetails.aspx.cs"
    Inherits="user_ShowPaymentDetails" %>--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/DataMiningMasterPage.master" AutoEventWireup="true" CodeFile="ShowPaymentDetails.aspx.cs" Inherits="user_ShowPaymentDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="shell">
                    <asp:Panel ID="Panel1" runat="server" Height="166px" Style="position: static" Width="741px">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Style="position: relative"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="OurPrice" HeaderText="Offer Price" />
