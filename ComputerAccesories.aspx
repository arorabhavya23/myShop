<%@ Page Title="" Language="C#" MasterPageFile="~/DataMiningMasterPage.master" AutoEventWireup="true" CodeFile="ComputerAccesories.aspx.cs" Inherits="ComputerAccesories" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server"   Height="528px" ScrollBars="Auto">
       <asp:DataList ID="DataList1" runat="server" CellSpacing="45" DataKeyField="ProdId" DataSourceID="SqlDataSource3" RepeatColumns="3">
            <ItemTemplate>
        ...
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ecomdatabaseConnectionString %>" SelectCommand="SELECT * FROM [NewProduct] WHERE ([CatgId] = '6')">
        </asp:SqlDataSource>
