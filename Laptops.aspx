<%@ Page Title="" Language="C#" MasterPageFile="~/DataMiningMasterPage.master" AutoEventWireup="true" CodeFile="Laptops.aspx.cs" Inherits="Laptops" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel2" runat="server"   Height="528px" ScrollBars="Auto">
       <asp:DataList ID="DataList1" runat="server" CellSpacing="45" DataKeyField="ProdId" DataSourceID="SqlDataSource4" RepeatColumns="3">
            <ItemTemplate>
                <table cellpadding="3" cellspacing="5" style="width: 91%">
                    <tr>
                        <td>
                            <asp:ImageButton ID="ImageButton2" runat="server" Height="212px"  commandargument='<%# Eval("Prodid") %>' ImageUrl='<%# Eval("image") %>' Width="219px" OnClick="ImageButton2_Click" />
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<asp:ImageButton ID="ImageButton1" runat="server" Height="27px" commandargument='<%# Eval("Prodid") %>' ImageUrl='~/css/images/addtocart.gif' Width="73px" OnClick="ImageButton1_Click" />
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ecomdatabaseConnectionString %>" SelectCommand="SELECT * FROM [NewProduct] WHERE ([CatgId] = '5')">
        </asp:SqlDataSource>
