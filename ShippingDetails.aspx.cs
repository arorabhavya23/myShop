...
public partial class user_ShippingDetails : System.Web.UI.Page
{
    ...
    {
        string Query = "select * from Login where id=" + Session["Uid"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        str = txtFname.Text + " " + txtLname.Text + ",Address : " + txtAddress.Text + ",City : " + txtCity.Text + ",State : " + txtState.Text + ",Pin Code : " + txtpincode.Text + ",Country : " + txtCountry.Text + ",E-MailId : " + txtemail.Text +  ",Mobile : " + txtMobile.Text;
        ...
        txtMobile.Text = "";  txtpincode.Text = ""; txtState.Text = "";
